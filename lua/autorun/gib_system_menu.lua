...
hook.Add("PopulateToolMenu","GIBBING_SYSTEM_MENU",function()
	spawnmenu.AddToolMenuOption("Options", "GIBBING SYSTEM Settings", "Gibbing System", "#GS.Settings","","",function(pnl)
		if game.SinglePlayer() or LocalPlayer():IsAdmin() then
			...
			pnl:CheckBox("#GS.Gib_Headless", "gibsystem_gib_headless")
			pnl:ControlHelp("#GS.Gib_Headless.Desc")
			pnl:NumSlider("#GS.SmallGibsRemoveTimer", "gibsystem_gib_removetimer", 0, 60, 0)
			pnl:TextEntry("#GS.HeadHealth", "gibsystem_head_health")
			pnl:TextEntry("#GS.BodyHealth", "gibsystem_body_health")
