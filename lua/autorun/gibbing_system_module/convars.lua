...
CreateConVar( "gibsystem_deathanimation", 0 , FCVAR, "[Gib System] Enable death animations.")
...
CreateConVar( "gibsystem_gib_headless", 0, FCVAR, "[Gib System] Gib Headless models." )
CreateConVar( "gibsystem_gib_removetimer", 10 , FCVAR, "[Gib System] Set gib remove timer.")
CreateConVar( "gibsystem_head_health", 20 , FCVAR, "[Gib System] Head's Health.")
CreateConVar( "gibsystem_body_health", 80 , FCVAR, "[Gib System] Body's Health.")
...
CreateClientConVar( "gibsystem_gfl2_skin_phongboost", 1 , true, false )
CreateClientConVar( "gibsystem_gfl2_skin_rimlight", 1 , true, false )
CreateClientConVar( "gibsystem_gfl2_skin_lightwarp", 1 , true, false )
CreateClientConVar( "gibsystem_gfl2_skin_color", 1.5 , true, false )
CreateClientConVar( "gibsystem_gfl2_skin_wetness", 0 , true, false )
